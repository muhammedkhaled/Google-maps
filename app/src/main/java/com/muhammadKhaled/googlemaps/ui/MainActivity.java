        ...
        ChatroomRecyclerAdapter.ChatroomRecyclerClickListener
{
    ...
    // this is a dialog to ask for permissions and enable GPS
        ...
        builder.setMessage("This application requires GPS to work properly, do you want to enable it?")
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(@SuppressWarnings("unused") final DialogInterface dialog, @SuppressWarnings("unused") final int id) {
                        ...
                        // i use start activity for result her to know if user accept permission or not
    ...
    // the user have GBS enabled in the device
